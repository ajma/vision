...
namespace Vision.Search
{
    ...
    {
        protected override float getSphericalScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
        ...
        protected override float getCylinderScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
        ...
        protected override float getAxisScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
        ...
        protected override float getAddScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
            return 0f;
        }

        protected override float getSunglassesScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
            return 0f;
        }

        protected override float getGenderScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
            return 0f;
        }

        protected override float getSizeScore(Glasses query, Models.Glasses glasses, System.Text.StringBuilder details)
        {
            return 0f;
        }
